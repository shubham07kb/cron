...
async function cronExec(req, res){
    ...
    await update(dburl, 'CronDB', 'last', { for: "lastCronJob" }, { $set: { data: { for: "lastCronJob", start_time: stimeStr, end_time: etimeStr, start_time_n: stimen, end_time_n: etimen, exexutedFrom: r } } })
    resp = { start_time_ic: stimeStr, end_time_ic: etimeStr, start_time: stimen, end_time: etimen, exexutedFrom: r  };
